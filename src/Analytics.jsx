...
import { useVisibleActiveBatch, useVisibleLogs, useVisibleTransactions, usePermissions } from './useStore';
...
export default function Analytics() {
  ...
  const transactionsRaw = useVisibleTransactions();
  const { canViewFinancial } = usePermissions();
  const showFinancials = canViewFinancial;
  const transactions = showFinancials ? transactionsRaw : [];
