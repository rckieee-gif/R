...
import { useStore, useVisibleActiveBatch, usePermissions } from './useStore';
...
export default function BatchManagement() {
  ...
  const setActiveBatch = useStore((state) => state.setActiveBatch);
  const token = useStore((state) => state.token);
  const previewData = useStore((state) => state.viewerSnapshot);
