...
export default function DailyLogForm({
  ...
  const watchActiveBuilding = watch('activeBuilding');
    ...
    <div className={`bg-app-card p-5 rounded-2xl border-2 transition-colors duration-300 mb-6 ${editingId ? 'border-app-accent bg-app-accent/5' : 'border-app-border'}`}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {errors.selectedEmployeeId && <p className="text-xs text-app-danger mt-1">{errors.selectedEmployeeId.message}</p>}
          {isLoading && (
        ...
        <div className="flex space-x-3 pt-2">
          <div className="flex-1">
            ...
            />
            {errors.feedConsumed && <p className="text-xs text-app-danger mt-1">{errors.feedConsumed.message}</p>}
          </div>
          <div className="flex-1">
            <label className="block text-[10px] font-black uppercase tracking-wider text-app-text-secondary mb-1.5">
              Mortality (Birds)
            ...
            />
            {errors.mortality && <p className="text-xs text-app-danger mt-1">{errors.mortality.message}</p>}
          </div>
        </div>
        ...
        <div>
          ...
          />
          {errors.averageWeightGrams && <p className="text-xs text-app-danger mt-1">{errors.averageWeightGrams.message}</p>}
        </div>
